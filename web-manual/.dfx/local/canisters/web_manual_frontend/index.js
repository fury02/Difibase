...
import { idlFactory } from './web_manual_frontend.did.js';
export { idlFactory } from './web_manual_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WEB_MANUAL_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./web_manual_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the web_manual_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./web_manual_frontend.did.js")._SERVICE>}
 */
export const web_manual_frontend = createActor(canisterId);
