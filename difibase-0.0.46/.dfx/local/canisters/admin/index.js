...
export const canisterId = process.env.ADMIN_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./admin.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the admin canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./admin.did.js")._SERVICE>}
 */
export const admin = createActor(canisterId);
