...
export interface TEST_DBEASY {
  'filling_datastructure' : ActorMethod<[], undefined>,
  'get_collection_tables' : ActorMethod<[], undefined>,
  'get_dbeasy' : ActorMethod<[], [] | [Principal]>,
  'init_dbeasy' : ActorMethod<[], undefined>,
  'test_datastructure' : ActorMethod<[], undefined>,
}
export interface Tokens { 'e8s' : bigint }
export type Wasm = Uint8Array;
export interface _SERVICE extends TEST_DBEASY {}
