...
export const canisterId = process.env.FRONT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./front.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the front canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./front.did.js")._SERVICE>}
 */
export const front = createActor(canisterId);
