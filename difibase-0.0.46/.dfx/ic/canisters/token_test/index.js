...
import { idlFactory } from './token_test.did.js';
export { idlFactory } from './token_test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOKEN_TEST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_test.did.js")._SERVICE>}
 */
export const token_test = createActor(canisterId);
