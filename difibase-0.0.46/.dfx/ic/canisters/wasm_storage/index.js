...
import { idlFactory } from './wasm_storage.did.js';
export { idlFactory } from './wasm_storage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WASM_STORAGE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wasm_storage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wasm_storage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wasm_storage.did.js")._SERVICE>}
 */
export const wasm_storage = createActor(canisterId);
