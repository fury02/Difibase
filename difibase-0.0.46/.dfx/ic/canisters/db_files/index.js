...
import { idlFactory } from './db_files.did.js';
export { idlFactory } from './db_files.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DB_FILES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./db_files.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the db_files canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./db_files.did.js")._SERVICE>}
 */
export const db_files = createActor(canisterId);
