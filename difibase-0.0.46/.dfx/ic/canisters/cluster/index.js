...
import { idlFactory } from './cluster.did.js';
export { idlFactory } from './cluster.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CLUSTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cluster.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cluster canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cluster.did.js")._SERVICE>}
 */
export const cluster = createActor(canisterId);
