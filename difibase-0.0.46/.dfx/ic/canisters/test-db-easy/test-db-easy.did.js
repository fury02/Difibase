export const idlFactory = ({ IDL }) => {
  ...
  const TEST_DBEASY = IDL.Service({
    'filling_datastructure' : IDL.Func([], [], []),
    'get_collection_tables' : IDL.Func([], [], []),
    'get_dbeasy' : IDL.Func([], [IDL.Opt(DBEASY)], []),
    'init_dbeasy' : IDL.Func([], [], []),
    'test_datastructure' : IDL.Func([], [], []),
  });
  return TEST_DBEASY;
};
