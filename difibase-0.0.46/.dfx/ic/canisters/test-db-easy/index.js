...
import { idlFactory } from './test-db-easy.did.js';
export { idlFactory } from './test-db-easy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST-DB-EASY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test-db-easy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test-db-easy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test-db-easy.did.js")._SERVICE>}
 */
export const test-db-easy = createActor(canisterId);
