...
import { idlFactory } from './db_easy.did.js';
export { idlFactory } from './db_easy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DB_EASY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./db_easy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the db_easy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./db_easy.did.js")._SERVICE>}
 */
export const db_easy = createActor(canisterId);
