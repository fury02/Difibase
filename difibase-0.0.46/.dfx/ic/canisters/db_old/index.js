...
import { idlFactory } from './db_old.did.js';
export { idlFactory } from './db_old.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DB_OLD_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./db_old.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the db_old canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./db_old.did.js")._SERVICE>}
 */
export const db_old = createActor(canisterId);
