                ...
                <Grid
                    ...
                    <Grid item xs={3}>
                        ...
                        <Stack>
                            ...
                            <FormControl>
                                <InputLabel htmlFor="my-input" color="secondary">Version instance db_***.wasm or other </InputLabel>
                            ...
                            <FormControl>
                                <InputLabel htmlFor="my-input" color="secondary">Name instance .wasm file(db_***.wasm or other) </InputLabel>
