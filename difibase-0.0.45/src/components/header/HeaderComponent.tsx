...
import logo from '../../assets/logo/logo_difibase.png' ;
                ...
                {/*<Nav className="justify-content-end" style={{ width: "100%" }}>*/}
                    <Nav className="mr-auto">
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="ms-auto text-center">
                                <Dropdown>
                                    <Dropdown.Toggle as={NavLink}>Usage</Dropdown.Toggle>
                                    <Dropdown.Menu variant="dark">
                            ...
                            <Nav className="ms-auto text-center">
                                <Dropdown  >
                                    ...
                                    <Dropdown.Menu variant="dark">
                                        ...
                                        {/*<NavDropdown.Divider/>*/}
                                        <NavDropdown.Item>
                                            <LinkContainer to="quickstart/handbook">
                                                <NavLink><h6 className="coral-color">Handbook</h6></NavLink>
                                            </LinkContainer>
                                        </NavDropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
