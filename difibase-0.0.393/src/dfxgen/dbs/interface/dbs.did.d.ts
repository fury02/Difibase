...
export interface DF_SERVICE {
  ...
  'canister_status' : ActorMethod<[string], canister_status_type>,
  ...
  'download_chunks' : ActorMethod<[UUID, bigint], [] | [Array<number>]>,
  ...
  'get_file_info' : ActorMethod< [UUID], [bigint, string, string, string, string, bigint]>,
  ...
  'replace_value' : ActorMethod< [string, string, string, string], [] | [string]>,
  'set_file_info' : ActorMethod<[bigint, string, string, string, string, bigint],[UUID, GUID]>,
  ...
  'upload_chunks' : ActorMethod<[Array<number>, UUID, bigint, bigint], UUID>,
  'upload_chunks_crc' : ActorMethod<[Array<number>, UUID, bigint, bigint, bigint],[UUID, boolean]>,
